...
void SDL2DisplayWindow::SetBorderColor(uint32_t rgba8)
{
	// SDL doesn't have this
}

void SDL2DisplayWindow::SetCaptionColor(uint32_t rgba8)
{
	// SDL doesn't have this
}

void SDL2DisplayWindow::SetCaptionTextColor(uint32_t rgba8)
{
	// SDL doesn't have this
}
